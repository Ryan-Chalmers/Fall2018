...
* Elasticity > 1: TE increase when price falls
* Elasticity < 1: TE decreases when price falls
* Demand is *elastic*, TE increases when price falls
* Demand is *inelastic*, TE decreases when price falls
...
* Situations in which the government may think about changing equilibrium
prices
